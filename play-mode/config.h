...
// ============================================================================
// PlayMode — Configuration globale
// ============================================================================
...
#define MAX_ACTUATORS           128     // Max actionneurs total (2 bus × 4 PCA × 16 ch)
...
#define MAX_NOTE_MAPPINGS       64      // Max mappings note par instrument (sparse, 1 par actuateur)
